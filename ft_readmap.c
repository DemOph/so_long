...
/*   Updated: 2021/09/24 19:00:26 by chael-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void map_texture_array(void)
{
	...
	while(++i < SIZE)
	{
		...
		while(++j < SIZE)
		{
			my_mlx_pixel_put(&mapped_texture, i, j, ((int *)texture.img)[(int)(j * ratio_y) * texture.img_width + (int)(i * ratio_x)]);
			// j++;
			// jj += ratio_y;
		}
		// ii += ratio_x;
...
int main(int argc, char **argv)
{
	...
	*/
	...
	ft_load_texture("/Users/chael-ha/Desktop/ft_cub 2/textures/bit.xpm", &texture);
	map_texture_array();
